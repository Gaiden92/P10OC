...
router.register('contributors', ContributorViewSet, basename='projects')

project_router = n_routers.NestedSimpleRouter(router, r'projects', lookup='project')
project_router.register(r"contributors", ContributorViewSet, basename="projects")
project_router.register(r'issues', IssueViewSet, basename='project-issues')

issue_router = n_routers.NestedSimpleRouter(project_router, r'issues', lookup='issue')
